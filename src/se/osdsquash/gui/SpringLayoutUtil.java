...
public class SpringLayoutUtil {
    ...
    public static void makeGrid(
        ...
        try {
            ...
            throw new RuntimeException(
                "The first argument to makeGrid must use SpringLayout. ClassCastException error: "
                    + exc.getMessage());
        }
        ...
        for (int i = 0; i < max; i++) {
            ...
            if (i % cols == 0) { //start of new row
                ...
                cons.setX(
                    Spring
                        .sum(lastCons.getConstraint(SpringLayout.EAST), Spring.minus(leftAdjust)));
            }
    ...
    public static void makeCompactGrid(
        ...
        try {
            ...
            throw new RuntimeException(
                "The first argument to makeCompactGrid must use SpringLayout. ClassCastException error: "
                    + exc.getMessage());
        }
